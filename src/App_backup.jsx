    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 ${presentationMode ? 'p-2' : 'p-4'} transition-all duration-300`}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="monitoramento" className="space-y-6">
          ...
          {/* Seções do Módulo de Monitoramento */}
          <div className="grid grid-cols-1 gap-6">
            
            {/* Scanntech Intelligence Center */}
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Scanntech Intelligence Center</span>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={cat.categoria} className={`p-3 bg-${cat.color}-50 rounded-lg border border-${cat.color}-200`}>
                        <div className={`text-sm text-${cat.color}-700 font-medium`}>{cat.categoria}</div>
                        <div className={`text-xl font-bold text-${cat.color}-800`}>{cat.share}%</div>
                        <div className={`text-xs text-${cat.color}-600`}>{cat.trend}</div>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>MTRIX Operations Center</span>
                  <Badge className="bg-green-100 text-green-800 border-green-200">Sell-Out</Badge>
                </CardTitle>
                <CardDescription>Performance operacional e dados de sell-out</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="text-sm text-blue-700 font-medium">Volume Total</div>
                    <div className="text-2xl font-bold text-blue-800">76.5M</div>
                    <div className="text-sm text-blue-600">+8.2% YoY</div>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="text-sm text-green-700 font-medium">Densidade Média</div>
                    <div className="text-2xl font-bold text-green-800">32.1</div>
                    <div className="text-sm text-green-600">unid/transação</div>
                  </div>
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <div className="text-sm text-orange-700 font-medium">Estados Ativos</div>
                    <div className="text-2xl font-bold text-orange-800">27</div>
                    <div className="text-sm text-orange-600">cobertura nacional</div>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="text-sm text-purple-700 font-medium">Ticket Médio</div>
                    <div className="text-2xl font-bold text-purple-800">R$ 4.85</div>
                    <div className="text-sm text-purple-600">+3.1% vs anterior</div>
                  </div>
                </div>

                {/* Top 5 Estados */}
                <div className="mb-6">
                  <h4 className="font-semibold text-slate-900 mb-3">Top 5 Estados por Performance</h4>
                  <div className="space-y-3">
                    {[
                      { estado: 'São Paulo', share: '26.9%', densidade: 85.4, status: 'Líder' },
                      { estado: 'Ceará', share: '26.5%', densidade: 37.2, status: 'Forte' },
                      { estado: 'Rio Grande do Norte', share: '26.4%', densidade: 31.8, status: 'Forte' },
                      { estado: 'Paraná', share: '15.9%', densidade: 42.1, status: 'Crescendo' },
                      { estado: 'Minas Gerais', share: '4.2%', densidade: 28.3, status: 'Estável' }
                    ].map((est, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                        <div className="flex-1">
                          <div className="font-medium text-slate-900">{est.estado}</div>
                          <div className="text-sm text-slate-600">Share: {est.share}</div>
                        </div>
                        <div className="text-center mx-4">
                          <div className="text-sm font-medium text-slate-900">{est.densidade} unid/trans</div>
                        </div>
                        <Badge variant={est.status === 'Líder' ? 'default' : 'outline'}>
                          {est.status}
                        </Badge>
                      </div>
                    ))}
                ...
                {/* Estados Críticos */}
                <div>
                  <h4 className="font-semibold text-slate-900 mb-3">Estados com Oportunidades Críticas</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      { estado: 'Rio de Janeiro', problema: 'Apenas 189 unidades', oportunidade: '1.000% potencial', acao: 'Operação resgate' },
                      { estado: 'Bahia', problema: 'Baixa densidade', oportunidade: '400% potencial', acao: 'Intensificar distribuição' },
                      { estado: 'Rio Grande do Sul', problema: 'Sem presença', oportunidade: '500% potencial', acao: 'Entrada estratégica' }
                    ].map((crit, idx) => (
                      <div key={idx} className="p-4 bg-red-50 rounded-lg border border-red-200">
                        <div className="font-medium text-red-900">{crit.estado}</div>
                        <div className="text-sm text-red-700 mt-1">{crit.problema}</div>
                        <div className="text-sm text-red-600 mt-2">💡 {crit.oportunidade}</div>
                        <div className="text-xs text-red-500 mt-1">→ {crit.acao}</div>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Amazon Digital Intelligence</span>
                  <Badge className="bg-orange-100 text-orange-800 border-orange-200">E-commerce</Badge>
                </CardTitle>
                <CardDescription>Performance digital e oportunidades online</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="text-sm text-blue-700 font-medium">Vendas Totais</div>
                    <div className="text-2xl font-bold text-blue-800">351K</div>
                    <div className="text-sm text-blue-600">unidades</div>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="text-sm text-green-700 font-medium">Crescimento</div>
                    <div className="text-2xl font-bold text-green-800">+12.5%</div>
                    <div className="text-sm text-green-600">produto líder</div>
                  </div>
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <div className="text-sm text-orange-700 font-medium">Share Digital</div>
                    <div className="text-2xl font-bold text-orange-800">0.5%</div>
                    <div className="text-sm text-orange-600">vs 99.5% físico</div>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="text-sm text-purple-700 font-medium">Potencial</div>
                    <div className="text-2xl font-bold text-purple-800">6-10x</div>
                    <div className="text-sm text-purple-600">crescimento</div>
                  </div>
                </div>

                {/* Top 5 Produtos Amazon */}
                <div>
                  <h4 className="font-semibold text-slate-900 mb-3">Top 5 Produtos Amazon</h4>
                  <div className="space-y-3">
                    {[
                      { produto: 'Barra Frutas Vermelhas', vendas: '21,906', crescimento: '+12.5%', posicao: 1 },
                      { produto: 'Barra Aveia Chocolate', vendas: '17,606', crescimento: '+8.3%', posicao: 2 },
                      { produto: 'Barra Proteína Amendoim', vendas: '16,600', crescimento: '-15.7%', posicao: 3 },
                      { produto: 'Barra Morango Chocolate', vendas: '16,248', crescimento: '+6.2%', posicao: 4 },
                      { produto: 'Barra Bolo Chocolate', vendas: '13,446', crescimento: '+9.8%', posicao: 5 }
                    ].map((prod, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                        <div className="flex items-center space-x-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${prod.posicao === 1 ? 'bg-yellow-500' : prod.posicao === 2 ? 'bg-gray-400' : prod.posicao === 3 ? 'bg-orange-600' : 'bg-slate-400'}`}>
                            {prod.posicao}
                          </div>
                          <div>
                            <div className="font-medium text-slate-900">{prod.produto}</div>
                            <div className="text-sm text-slate-600">{prod.vendas} unidades</div>
                          </div>
                        </div>
                        <Badge variant={prod.crescimento.startsWith('+') ? 'default' : 'destructive'}>
                          {prod.crescimento}
                        </Badge>
                      </div>
                    ))}
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Centro de Explicações de Mercado</span>
                  <Badge className="bg-purple-100 text-purple-800 border-purple-200">Insights</Badge>
                </CardTitle>
                <CardDescription>Análises causais e explicações de movimentos</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    {
                      titulo: 'Queda Share Proteína (-3.2%)',
                      explicacao: 'Integralmédica intensificou marketing digital com foco em atletas, aumentando preço médio em 8% e capturando consumidores premium.',
                      impacto: 'Perda de R$ 2.3M em receita',
                      acao: 'Desenvolver linha proteína premium',
                      data: 'Nov/24'
                    },
                    {
                      titulo: 'Trio Lança Mini Barra (+15% vendas)',
                      explicacao: 'Trio antecipou tendência de miniaturização com barra 18g, posicionamento "snack saudável" e distribuição em conveniências.',
                      impacto: 'Pressão competitiva crescente',
                      acao: 'Acelerar Nutry Mini',
                      data: 'Dez/24'
                    },
                    {
                      titulo: 'Crescimento Frutas Vermelhas (+12.5%)',
                      explicacao: 'Sabor beneficiado por tendência antioxidante e campanha "Energia Natural". Sazonalidade verão potencializou vendas.',
                      impacto: 'Liderança consolidada',
                      acao: 'Expandir linha frutada',
                      data: 'Out/24'
                    }
                  ].map((exp, idx) => (
                    <div key={idx} className="p-4 bg-gradient-to-r from-slate-50 to-slate-100 rounded-lg border">
                      <div className="flex items-start justify-between mb-2">
                        <h5 className="font-semibold text-slate-900">{exp.titulo}</h5>
                        <Badge variant="outline" className="text-xs">{exp.data}</Badge>
                      </div>
                      <p className="text-sm text-slate-700 mb-3">{exp.explicacao}</p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="flex items-center space-x-2">
                          <span className="text-xs font-medium text-slate-600">Impacto:</span>
                          <span className="text-xs text-slate-800">{exp.impacto}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <span className="text-xs font-medium text-slate-600">Ação:</span>
                          <span className="text-xs text-blue-600">{exp.acao}</span>
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        <TabsContent value="estrategia" className="space-y-6">
          ...
          {/* Nova Seção: Bases de Dados Scanntech e MTRIX */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
            {/* Scanntech Intelligence */}
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span>Scanntech Intelligence</span>
                </CardTitle>
          ...
          <Card className="border-0 shadow-lg mt-6">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Alertas Integrados Scanntech + MTRIX</span>
              </CardTitle>
