...
const ModeloPreditivoAprimorado = () => {
  ...
  const melhorias = [
    { fonte: 'Amazon', impacto: 0.20, cor: 'bg-cyan-500' },
    { fonte: 'Regional', impacto: 0.12, cor: 'bg-cyan-400' },
    { fonte: 'Marketing', impacto: 0.08, cor: 'bg-cyan-300' },
    { fonte: 'Histórico', impacto: 0.15, cor: 'bg-cyan-500' },
    { fonte: 'Consumidor', impacto: 0.05, cor: 'bg-cyan-200' }
  ];
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          <div className="text-sm text-slate-600 font-medium">R² Anterior</div>
          <div className="text-2xl font-bold text-slate-700">{modeloData.r2_atual.toFixed(3)}</div>
        </div>
        
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          <div className="text-sm text-slate-600 font-medium">R² Novo</div>
          <div className="text-2xl font-bold text-cyan-500">{modeloData.r2_novo.toFixed(3)}</div>
        </div>
        
        <div className="bg-white border border-slate-200 rounded-lg p-4">
          <div className="text-sm text-slate-600 font-medium">Melhoria</div>
          <div className="text-2xl font-bold text-cyan-500">+{modeloData.melhoria_percentual.toFixed(1)}%</div>
        </div>
      </div>
